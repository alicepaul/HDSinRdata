...
female_vars <- c(paste("P12_0", 31:39, "N", sep = ""), # All Female
                 paste("P12H_0", 31:39, "N", sep = ""),  # Hispanic Female
                 paste("P12I_0", 31:39, "N", sep = ""),  # White Female
...
tex_cens <- tex_cens %>% mutate(tot_pop = rowSums(tex_cens[ , paste("P12_0", 31:39, "N", sep = "")]),
         white = rowSums(tex_cens[ , paste("P12I_0", 31:39, "N", sep = "")]),
         hispanic = rowSums(tex_cens[ , paste("P12H_0", 31:39, "N", sep = "")]),
         black = rowSums(tex_cens[ , paste("P12J_0", 31:39, "N", sep = "")]),
         native_american = rowSums(tex_cens[ , paste("P12K_0", 31:39, "N", sep = "")]),
         asian = rowSums(tex_cens[ , paste("P12L_0", 31:39, "N", sep = "")]),
         other = rowSums(tex_cens[ , c(paste("P12M_0", 31:39, "N", sep = ""),
                                       paste("P12N_0", 31:39, "N", sep = ""),
                                       paste("P12O_0", 31:39, "N", sep = ""))]),
